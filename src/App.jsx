...
import AOS from 'aos';
import 'aos/dist/aos.css'; // You can also use <link> for stylenp
        ...
        <div className="min-h-screen bg-white text-zinc-900 dark:bg-neutral-900 dark:text-white transition-colors duration-300">
            ...
            <div className="max-w-7xl mx-auto px-4 lg:px-4 mt-2">
                ...
                <section id="project" className="proyek mt-32">
                    <h1 className="text-4xl text-center font-bold mb-4" data-aos="fade-up" data-aos-duration="1000">
                    ...
                    <p className="text base/loose text-center opacity-50" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300">
                        {translations[language].projectsDesc}
                    </p>
                    ...
                    <div className='proyek-box mt-14 grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-4'>
                        {listProyek.map((proyek) => (
                            <div
                                key={proyek.id}
                                className='p-4 rounded-md bg-neutral-200 border dark:bg-neutral-800 dark:border-white flex flex-col h-full'
                                data-aos="fade-up"
                            ...
                            >
                                ...
                                <div className='flex flex-col flex-grow'>
                                    ...
                                    <p className='text-sm/loose mb-4 text-justify'>
                                        {translations[language][proyek.desk]}
                                    </p>
                                    ...
                                    <div className='flex flex-wrap gap-2'>
                                        {proyek.tools.map((tool, index) => (
                                            <p
                                                key={index}
                                                className='border border-neutral-500 bg-neutral-700 px-3 py-1 rounded-md text-white '
                                            >
                                                {tool}
                                            </p>
                                        ))}
                                    ...
                                    <div className='mt-auto text-center'>
                                        <a
                                            href={proyek.url}
                                            className='bg-emerald-600 mt-6 p-3 rounded-lg block border border-emerald-600 hover:bg-emerald-500 text-white'
                                            target="_blank"
